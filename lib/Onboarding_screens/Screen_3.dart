...
import 'package:wayelle/Sign_up/forgot_password_screen.dart';

import '../Login_screen/login_screen.dart';

class Onscreen3 extends StatefulWidget {
  final Function(String) switchLanguage;
  Onscreen3({Key? key, required this.switchLanguage}) : super(key: key);
  @override
  State<Onscreen3> createState() => _Onscreen1State();
}

class _Onscreen1State extends State<Onscreen3> {
  @override
      ...
      body: Stack(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Explore our wide selection of clothing and accessories for men, women, and kids.',
              textAlign: TextAlign.center,
