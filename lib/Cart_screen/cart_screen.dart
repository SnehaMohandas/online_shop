                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              for (int i = 0;
                                ...
                                double convertedValue = double.parse(
                                    ds.replaceAll(',', '').replaceAll(
                                          '\$',
                                          '',
                                        ));
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      await cartController.editCart(
                                                                          //  customer_id,
                                                                          cartController.cart!.cartproduct[index].productId,
                                                                          "-1",
                                                                          cartController.cart!.cartproduct[index].option[0].productOptionId,
                                                                          cartController.cart!.cartproduct[index].option[0].productOptionValueId);
                                                                      quantity =
                                                                          0;
                                                                      cartController
                                                                          .fetchCart();
